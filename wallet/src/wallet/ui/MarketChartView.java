...
public class MarketChartView extends View {
    ...
    // FIX: background must stay auto (bgColor=0) when changing other appearance.
    // Do not lock background to light/dark by saving bColor here.
    // bg is only saved via setBgColor() explicitly.
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        // Intentionally not saving txtColor, gColor, bColor here
        // to keep chart background auto-follow theme like after reset.
        // Use setPriceTextColor(), setGridColor(), setBgColor() separately if needed.
    }

    // FIX: same - do not save bg here, keep auto
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        setCurrentPriceLabelBackground(lastBgColor);
        setPriceTextSizePx(txtSize);
        // Intentionally not saving txtColor, gColor, background here
    }
