...
public class MarketChartView extends View {
    ...
    private void loadViewDimensions(Context context) {
        ...
        try {
            ...
            CANDLE_MIN_HEIGHT = (int) context.getResources()
                .getDimension(R.dimen.default_candle_min_width);
        }
        ...
        // Load Volume MA defaults from integers/dimens - no hardcode
        try {
    ...
    public void setDefaultsFromLayout(float bodyFrac, float wickW, float maW, int visCount,
        ...
        try {
            fallbackSelectedColor = getContext().getResources()
    ...
    private void reloadDefaultColorsFromCurrentTheme() {
        try {
            ...
            // Keep old defaults if reload fails
        }
    }
    ...
    private void loadChartOptions(Context context) {
        ...
        try {
            ...
            lastPriceLineColor = sp.contains(
            ...
            gridColor = sp.contains(context.getString(R.string.key_grid_color))?
                    sp.getInt(context.getString(R.string.key_grid_color), defGridColor) :
                    defGridColor;
            ...
            lastPriceLabelTextColor = sp.contains(
            ...
            volMa1Color = sp.contains(context.getString(R.string.key_vol_ma1_color))?
                    sp.getInt(context.getString(R.string.key_vol_ma1_color), volMa1Color) :
                    volMa1Color;

            volMa2Color = sp.contains(context.getString(R.string.key_vol_ma2_color))?
                    sp.getInt(context.getString(R.string.key_vol_ma2_color), volMa2Color) :
                    volMa2Color;
    ...
    // --------------------------------------------------------------------
    // Public getters - each field separated
    // --------------------------------------------------------------------
    ...
    public void setBodyFraction(float fraction) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && fraction == defBodyFraction) {
                sp.edit().remove(getContext().getString(R.string.key_body_fraction)).apply();
            } else {
    ...
    public void setWickWidthPx(float widthPx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && widthPx == defWickWidthPx) {
                sp.edit().remove(getContext().getString(R.string.key_wick_width)).apply();
            } else {
    ...
    public void setMaLineWidthPx(float widthPx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && widthPx == defMaWidthPx) {
                sp.edit().remove(getContext().getString(R.string.key_ma_width)).apply();
            } else {
    ...
    public void setShowGrid(boolean show) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && show == defShowGrid) {
                sp.edit().remove(getContext().getString(R.string.key_show_grid)).apply();
            } else {
    ...
    public void setShowVolume(boolean show) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && show == defShowVolume) {
                sp.edit().remove(getContext().getString(R.string.key_show_volume)).apply();
            } else {
    ...
    public void setVisibleCandleCount(int count) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && this.visibleCandleCount == defVisibleCount) {
                sp.edit().remove(getContext().getString(R.string.key_visible_count)).apply();
            } else {
    ...
    public void setShowLastPriceLine(boolean show) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && show == defShowLastPrice) {
                sp.edit().remove(getContext().getString(R.string.key_show_last_price)).apply();
            } else {
    ...
    public void setLastPriceLineColor(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defLastPriceLineColor) {
    ...
    public void setPriceTextSizePx(float sizePx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && sizePx == defPriceTextSizePx) {
                sp.edit().remove(getContext().getString(R.string.key_price_text_size)).apply();
            } else {
    ...
    public void setLastLineWidthPx(float widthPx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && widthPx == defLastLineWidthPx) {
                sp.edit().remove(getContext().getString(R.string.key_last_line_width)).apply();
            } else {
    ...
    public void setLastLineDashed(boolean dashed) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && dashed == defLastDashed) {
                sp.edit().remove(getContext().getString(R.string.key_last_line_dash)).apply();
            } else {
    ...
    public void setCurrentPriceLabelTextSizePx(float sizePx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && sizePx == defLabelTextSizePx) {
                sp.edit().remove(getContext().getString(R.string.key_last_label_text_size)).apply();
            } else {
    ...
    public void setGridColor(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defGridColor) {
    ...
    public void setPriceTextColor(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defPriceTextColor) {
    ...
    public void setCurrentPriceLabelBackground(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defLastPriceBgColor) {
    ...
    public void setCurrentPriceLabelTextColor(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defLabelTextColor) {
    ...
    public void setSelectedLineColor(int color) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && color == defSelectedLineColor) {
    ...
    public void setSelectedLineWidthPx(float widthPx) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && widthPx == defSelectedLineWidthPx) {
                sp.edit().remove(getContext().getString(R.string.key_selected_line_width)).apply();
            } else {
    ...
    public void setSelectedLineAlpha(int alpha) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && alpha == defSelectedAlpha) {
                sp.edit().remove(getContext().getString(R.string.key_selected_line_alpha)).apply();
            } else {
    ...
    public void setSelectedLineDashed(boolean dashed) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && dashed == defSelectedDashed) {
                sp.edit().remove(getContext().getString(R.string.key_selected_line_dash)).apply();
            } else {
    ...
    public void setCandleColors(int bull, int bear) {
        ...
        try {
            ...
            if (defaultsLoadedFromLayout && bull == defBullColor && bear == defBearColor) {
                sp.edit().clear().apply();
            } else {
                sp.edit()
    ...
    // FIXED: Do NOT overwrite grid/price text with old theme color.
    // When user set in old theme -> custom is already in prefs and kept by loadChartOptions().
    // When auto -> stays auto (def new). When set after theme change -> keep after-change state + new set.
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        if (lastLineColor == 0 || lastBgColor == 0) {
            throw new IllegalStateException(
                    getContext().getString(R.string.err_appearance_color)
            );
        }
        ...
        // IMPORTANT: Don't call setGridColor / setPriceTextColor here.
        // Grid and price text are managed separately:
        // - if already custom in prefs, loadChartOptions() keeps it after theme change
        // - if auto, it stays def new
        // - only setGridColor / setPriceTextColor when user explicitly picks a color
    }
    ...
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        setCurrentPriceLabelBackground(lastBgColor);
        setPriceTextSizePx(txtSize);
        // Same - do not overwrite grid / price text with old theme values
    }
    ...
    public void resetToDefaultsFromLayout() {
        ...
        // Reset Volume MA - load from integers/dimens, no hardcode
        try {
    ...
    private void initPaints(Context context) {
        ...
        // bgColor==0 => auto theme, like just after reset
        if (bgColor == 0) {
            setBackgroundColor(themeBg);
        } else {
    ...
    private void drawVolumeHeader(Canvas canvas, float y) {
        ...
        // Format like Binance: VOL: xxxxx MA(5): xxxxx MA(10): xxxxx
        String volStr = String.format(Locale.US, "Vol: %.2f ", lastVolValue);
        String ma5Str = String.format(Locale.US, "MA(%d): %.2f ", volMa1Period, lastVolMa1Value);
        String ma10Str = String.format(Locale.US, "MA(%d): %.2f", volMa2Period, lastVolMa2Value);
