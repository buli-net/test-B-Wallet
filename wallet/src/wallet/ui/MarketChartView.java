...
public class MarketChartView extends View {
    ...
    /**
     * FIXED theo yêu cầu:
     * - Không bao giờ mang auto theme cũ qua theme mới
     * - Chỉ lưu cái user set, cái nào không set thì auto
     * - Grid và PriceText phải set riêng qua setGridColor / setPriceTextColor
     * - setChartAppearance chỉ lo LastPrice line, không đụng Grid/Price
     */
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        // KHÔNG setGridColor / setPriceTextColor ở đây - tránh mang auto cũ qua
    }
    ...
    public void setChartAppearance(boolean sLastPrice, int lastLineColor, int lastBgColor,
        ...
        setCurrentPriceLabelBackground(lastBgColor);
        setPriceTextSizePx(txtSize);
        // KHÔNG setGridColor / setPriceTextColor ở đây
    }
